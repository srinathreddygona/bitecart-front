...
export const login=(email,password)=>async (dispatch)=>{
    try{
        ...
        const {data}=await axios.post(
            `https://bitecart-back.onrender.com/api/v1/users/login`,
            {email,password},
            config
        );
        dispatch({
...
export const register=(userData)=>async (dispatch)=>{
    try{
        ...
        const {data}=await axios.post(`https://bitecart-back.onrender.com/api/v1/users/signup`,userData,config);
        dispatch({
...
export const updateProfile=(userData)=>async(dispatch)=>{
    try{
        ...
        const {data}=await axios.put(
            "https://bitecart-back.onrender.com/api/v1/users/me/update",
            userData,
            config
        );
...
export const forgotPassword=(email)=>async(dispatch)=>{
    try {
        ...
        const {data}=await axios.post(
            "https://bitecart-back.onrender.com/api/v1/users/forgetPassword",
            email,config
        );
        dispatch({
